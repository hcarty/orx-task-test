...
solution "runtask"
    ...
    configuration {"web"}
        ...
        buildoptions
        {
            "-DorxWEB_EXECUTABLE_NAME='\"runtask.wasm\"'",
        ...
        linkoptions
        {
            "--preload-file " .. copybase .. "/build/runtask.obr@/",
    ...
    configuration {"web", "Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && runtask -b ../build/runtask.obr"}
        postbuildcommands {"del " .. path.translate(copybase, "\\") .. "\\build\\runtask.obr"}

    configuration {"web", "not Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && ./runtask -b ../build/runtask.obr"}
        postbuildcommands {"rm " .. copybase .. "/build/runtask.obr"}
